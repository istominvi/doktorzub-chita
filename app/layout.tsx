...
export const metadata: Metadata = {
  ...
  description: 'Стоматология в Чите с 20-летним опытом. Лечение зубов, протезирование, отбеливание, детская стоматология. Бесплатная консультация. Запись: 8 (3022) 32-06-30, +7 (914) 133-88-87',
